...
export interface OperationResultState<Data = any, Variables = object> extends OperationResult<Data, Variables> {
    fetching: boolean;
}
/** A Readable containing an `OperationResult` with a fetching flag. */
export declare type OperationResultStore<Data = any, Variables = object> = Readable<OperationResultState<Data, Variables>>;
