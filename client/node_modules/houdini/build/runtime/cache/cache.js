...
class Cache {
    constructor(config) {
        this._internal_unstable = new CacheInternal({
            ...
            lists: new lists_1.ListManager(this, exports.rootID),
...
class CacheInternal {
    ...
    writeSelection({ data, selection, variables = {}, root = exports.rootID, parent = exports.rootID, applyUpdates = false, layer, toNotify = [], forceNotify, }) {
        ...
        for (const [field, value] of Object.entries(data)) {
            ...
            const key = (0, stuff_1.evaluateKey)(keyRaw, variables);
            ...
            if (!fields) {
                ...
                const valueChanged = !(0, lib_1.deepEquals)(newValue, previousValue);
            ...
            // if we are writing `null` over a link
                ...
                const previousLinks = (0, stuff_1.flattenList)([previousValue]);
            ...
            // the field could point to a linked object
                ...
                const embedded = this.idFields(linkedType)?.filter((field) => typeof value[field] === 'undefined').length > 0;
            ...
            // the field could point to a list of related objects
                ...
                const contentChanged = !(0, lib_1.deepEquals)(linkedIDs, oldIDs);
    ...
    getSelection({ selection, parent = exports.rootID, variables, stepsFromConnection = null, }) {
    ...
    idFields(type) {
        return (0, lib_1.keyFieldsForType)(this.config, type);
    }
    computeID(type, data) {
        return (0, lib_1.computeID)(this.config, type, data);
    }
    ...
    extractNestedListIDs({ value, abstract, recordID, key, linkedType, fields, variables, applyUpdates, specs, layer, forceNotify, }) {
        ...
        for (const [i, entry] of value.entries()) {
            ...
            // required to compute the entity's id
            const embedded = this.idFields(linkedType)?.filter((field) => typeof entry[field] === 'undefined').length > 0;
