...
import { PaginatedDocumentHandlers } from '../lib/pagination';
...
export declare function paginatedQuery<_Query extends Operation<any, any>>(document: GraphQLTagResult): QueryResponse<_Query['result'], _Query['input']> & PaginatedDocumentHandlers<_Query['result'], _Query['input']>;
export {};
