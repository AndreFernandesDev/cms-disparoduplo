...
exports.testConfig = exports.testConfigFile = void 0;
...
exports.testConfigFile = testConfigFile;
function testConfig(config = {}) {
    return new common_1.Config({
        filepath: path_1.default.join(process.cwd(), 'config.cjs'),
