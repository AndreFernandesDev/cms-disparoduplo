...
exports.definitionFromAncestors = exports.parentTypeFromAncestors = exports.hashDocument = exports.getRootType = void 0;
...
function hashDocument(document) {
    ...
    // hash the string
    return crypto_1.default.createHash('sha256').update(docString).digest('hex');
}
...
exports.parentTypeFromAncestors = parentTypeFromAncestors;
...
exports.definitionFromAncestors = definitionFromAncestors;
