...
export function fragmentHandlers({ config, paginationArtifact, initialValue, store, }) {
    var _a, _b;
...
export function queryHandlers({ config, artifact, store, queryVariables, }) {
...
function paginationHandlers({ initialValue, artifact, store, queryVariables, documentLoading, refetch, config, }) {
    ...
    let pageInfo = readable(nullPageInfo());
    // loading state
...
function cursorHandlers({ config, initialValue, artifact, store, queryVariables: extraVariables, loading, refetch, }) {
    ...
    const initialPageInfo = (_a = extractPageInfo(initialValue, artifact.refetch.path)) !== null && _a !== void 0 ? _a : nullPageInfo();
    ...
    const loadPage = async ({ houdiniContext, pageSizeVar, input, functionName, }) => {
        ...
        const loadVariables = {
            ...extraVariables === null || extraVariables === void 0 ? void 0 : extraVariables(),
...
function offsetPaginationHandler({ artifact, queryVariables: extraVariables, loading, refetch, initialValue, store, config, }) {
    ...
    let currentOffset = ((_a = artifact.refetch) === null || _a === void 0 ? void 0 : _a.start) ||
