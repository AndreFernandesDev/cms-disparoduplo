...
export function queryStore({ config, artifact, storeName, paginationMethods, paginated, }) {
    ...
    async function fetch(args) {
        ...
        const isLoadFetch = Boolean(params === null || params === void 0 ? void 0 : params.event);
        ...
        if (isLoadFetch && lastVariables === null && Boolean(args === null || args === void 0 ? void 0 : args.event)) {
            blockNextCSF = true;
        }
...
`);
    ...
    let context = params === null || params === void 0 ? void 0 : params.event;
    if (!context) {
        const houdiniContext = (params === null || params === void 0 ? void 0 : params.context) || nullHoudiniContext();
        context = {
            fetch: window.fetch.bind(window),
            session: (_b = houdiniContext.session) === null || _b === void 0 ? void 0 : _b.call(houdiniContext),
            stuff: houdiniContext.stuff || {},
        };
    }
    // Add metadata info to the context
    context = { ...context, metadata: params === null || params === void 0 ? void 0 : params.metadata };
    return { context, policy, params: params !== null && params !== void 0 ? params : {} };
}
