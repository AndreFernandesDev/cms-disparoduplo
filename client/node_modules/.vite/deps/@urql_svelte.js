...
function z(a) {
  return function(b) {
    return function(c2) {
      function d2(b2) {
        "number" == typeof b2 ? k && (k = false, void 0 !== (b2 = e.shift()) ? (b2 = a(x(b2)), k = true, b2(d2)) : q ? c2(0) : g || (g = true, f2(0))) : b2.tag ? k && (c2(b2), n ? n = false : h2(0)) : (h2 = b2 = b2[0], n = false, b2(0));
      }
      let e = [], f2 = m, g = false, h2 = m, k = false, n = false, q = false;
      b(function(b2) {
        "number" == typeof b2 ? q || (q = true, k || 0 !== e.length || c2(0)) : b2.tag ? q || (b2 = b2[0], g = false, k ? e.push(b2) : (b2 = a(b2), k = true, b2(d2))) : f2 = b2[0];
      });
      c2(l(0, [
        function(c3) {
          if (c3) {
            ...
            q || g || (g = true, f2(0)), k && !n && (n = true, h2(0));
          }
        }
      ]));
    };
...
function D(a) {
  return function(b) {
    return function(c2) {
      ...
      b(function(b2) {
        "number" == typeof b2 ? h2 || (h2 = true, 0 === g.length && c2(0)) : b2.tag ? h2 || (f2 = false, function(a2) {
          function b3(a3) {
            "number" == typeof a3 ? 0 !== g.length && (g = g.filter(d2), a3 = 0 === g.length, h2 && a3 ? c2(0) : !f2 && a3 && (f2 = true, e(0))) : a3.tag ? 0 !== g.length && (c2(l(1, [a3[0]])), k(0)) : (k = a3 = a3[0], g = g.concat(a3), a3(0));
          }
          function d2(a3) {
            return a3 !== k;
          }
...
function K(a) {
  return function(b) {
    return function(c2) {
      function d2(a2) {
        h2 && ("number" == typeof a2 ? (h2 = false, n ? c2(a2) : f2 || (f2 = true, e(0))) : a2.tag ? (c2(a2), k ? k = false : g(0)) : (g = a2 = a2[0], k = false, a2(0)));
      }
      let e = m, f2 = false, g = m, h2 = false, k = false, n = false;
      b(function(b2) {
        "number" == typeof b2 ? n || (n = true, h2 || c2(0)) : b2.tag ? n || (h2 && (g(1), g = m), f2 ? f2 = false : (f2 = true, e(0)), b2 = a(b2[0]), h2 = true, b2(d2)) : e = b2[0];
      });
      c2(l(0, [
        function(a2) {
          if (a2) {
    ...
    return function(c2) {
      return function(d2) {
        ...
        return c2(function(c3) {
          "number" == typeof c3 ? c3 = 0 : c3.tag ? (e = a2(e, c3[0]), c3 = l(1, [e])) : c3 = l(0, [c3[0]]);
          d2(c3);
        });
      };
    };
...
function stringifyDocument(e) {
  var r2 = ("string" != typeof e ? e.loc && e.loc.source.body || print(e) : e).split(u).map(replaceOutsideStrings).join("");
  if ("string" != typeof e) {
...
var p2 = "undefined" != typeof TextDecoder ? new TextDecoder() : null;
var h = /content-type:[^\r\n]*application\/json/i;
var d = /boundary="?([^=";]+)"?/i;
function makeFetchSource(e, r2, t2) {
  ...
  return make$1(function(a) {
      ...
      return i3().then(function next(n3) {
        if (!n3.done) {
          var o4 = function toString(e3) {
            return "Buffer" === e3.constructor.name ? e3.toString() : p2.decode(e3);
          }(n3.value);
    ...
    Promise.resolve().then(function() {
      ...
      v3 = (m2 = r3).status < 200 || m2.status >= n;
      return executeIncrementalFetch(i2, e, m2);
    }).then(s2).catch(function(r3) {
      if (f2) {
        throw r3;
      }
      var t3 = makeErrorResult(e, v3 ? m2.statusText ? new Error(m2.statusText) : r3 : r3, m2);
      i2(t3);
      s2();
    });
    return function() {
...
function ssrExchange(e) {
  ...
  var ssr = function(a2) {
    ...
    var i2 = a2.forward;
    return function(a3) {
      var u2 = e && "boolean" == typeof e.isClient ? !!e.isClient : !o2.suspense;
      var s2 = share$1(a3);
    ...
    return function(e3) {
      ...
      var a2 = D(function(e4) {
        ...
        var u3 = filter$1(function(e5) {
          return "teardown" === e5.kind && e5.key === a3;
        })(t3);
...
var J2 = function Client(e) {
  ...
  var h2 = composeExchanges(void 0 !== e.exchanges ? e.exchanges : L);
  var y = share$1(h2({
    client: f2,
    dispatchDebug: p3,
...
function fromStore(e) {
  return make$1(function(t2) {
    return e.subscribe(t2.next);
  });
}
var v2 = {
  fetching: false,
...
function queryStore(t2) {
  var n = createRequest(t2.query, t2.variables);
  var x2 = _extends2({}, {
    requestPolicy: t2.requestPolicy
  }, t2.context);
  var p3 = t2.client.createRequestOperation("query", n, x2);
  var d2 = _extends2({}, v2, {
    operation: p3
  });
  var b = writable(d2, function() {
    return m2.unsubscribe;
  });
  var q = writable(!!t2.pause);
  var m2 = N(function(e) {
    b.set(e);
  })(scan$1(function(e, t3) {
    return _extends2({}, e, t3);
  }, d2)(K(function(e) {
    if (e) {
      return never$1;
    }
    ...
    })(t2.client.executeRequestOperation(p3)), fromValue$1({
      fetching: false
    })]);
  })(fromStore(q))));
  return _extends2({}, derived(b, function(e, t3) {
    t3(e);
  }), createPausable(q));
}
function mutationStore(t2, n) {
  var i2 = createRequest(t2.query, t2.variables);
  var a = t2.client.createRequestOperation("mutation", i2, t2.context);
  var u2 = _extends2({}, v2, {
    operation: a,
    fetching: true
  });
  ...
  var x2 = N(function(e) {
    ...
    return _extends2({}, e, t3, {
      data: void 0 !== t3.data ? "function" == typeof n ? n(e.data, t3.data) : t3.data : e.data
    });
  }, u2)(map$1(function(e) {
    return {
      fetching: false,
  ...
  })(t2.client.executeRequestOperation(a))));
  return derived(s2, function(e, t3) {
    t3(e);
    return x2.unsubscribe;
  });
}
function subscriptionStore(t2) {
  var n = createRequest(t2.query, t2.variables);
  var x2 = t2.client.createRequestOperation("subscription", n, t2.context);
  var p3 = _extends2({}, v2, {
    operation: x2
  });
  var d2 = writable(p3, function() {
  ...
  var q = N(function(e) {
    ...
    })(t2.client.executeRequestOperation(x2)), fromValue$1({
      fetching: false
    })]);
  })(fromStore(b))));
  return _extends2({}, derived(d2, function(e, t3) {
    t3(e);
  }), createPausable(b));
}
function getContextClient() {
  var e = getContext("$$_urql");
  if (!e) {
